...
function CustomMail({ threadId, onClose }: any) {
  // State to manage reply form data
  ...
  const handleSendReply = async () => {
    ...
    try {
      // Send the reply data to the API
      await axios.post(
      ...
      // Log a success message and close the modal
      console.log("Reply sent successfully");
      onClose();
    }
  };

  // Handle changes in the input fields (to, from, subject)
  ...
  // Handle changes in the textarea (body)
  ...
  return (
    ...
    <div className="bg-gray-400/25 fixed top-0 left-0 flex justify-center items-center h-full w-full z-20">
      ...
      <div className="bg-[#141517] w-1/2 h-4/5 rounded-lg border border-[#41464B]">
        ...
        {/* Footer with send button and additional options */}
